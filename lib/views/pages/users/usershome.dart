...
import 'package:bams_tms/views/pages/activation/activation.dart';
...
class _UserHomeState extends State<UserHome>  {
  ...
  void initState() {
    ...
    fnGetPageData();
    timer = Timer.periodic(const Duration(seconds: 300), (Timer t) => fnRefresh);
    super.initState();
    ...
    return Scaffold(
      ...
      Container(
        ...
        child: Row(
          ...
          children: [
            ...
            Expanded(child: NewTask(pageMode: lstrTTaskMode, wMainClienId: lstrTMainCompanyCode, wDoco: lstrTTaskDocno, wDoctype: lstrTTaskDoctype, fnGetTask: apiGetTask, wSubOfDocno: lstrTSubTaskOf, fnSubTaskCall: fnSubTaskCall,)),
      ...
      Container(
        ...
        child: Row(
          crossAxisAlignment: CrossAxisAlignment.start,
          children:  [
            Expanded(child: TaskAssign(fnCallBack: fnTaskCallBack,))
          ],
        ),
                ...
                Container(
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      wMenuCard(Icons.home_outlined,g.wstrUserRole == "DEPHEAD"?g.wstrUserDepartmentDescp.toString():"Home","H"):gapHC(0),
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          tc((openTicket+closedTicket+droppedTicket+holdTickets+activeTickets).toString(), color2 , 25),
                                          tcn1('Total Task  ', color3 , 12),
                                          tcn1('Filter ${(fOpenTicket+fClosedTicket+fDroppedTicket+fHoldTickets+fActiveTickets).toString()}  ', Colors.blueAccent , 12)
                                        ],
                                      )
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          tc((openTicket+activeTickets+holdTickets).toString(), Colors.green , 25),
                                          tcn1('Open Task  ', color3 , 12),
                                          tcn1('Filter ${(fActiveTickets+fHoldTickets+fOpenTicket).toString()}  ', Colors.blueAccent , 12)
                                        ],
                                      )
                            ...
                            Flexible(
                              child: Bounce(
                                ...
                                child: Container(
                                  ...
                                  child: Row(
                                    children: [
                                      const Icon(Icons.play_circle_outline_sharp,color: color2,size: 30,),
                                      gapWC(10),
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          tc(activeTickets.toString(), color2 , 25),
                                          tcn1('Started  ', color3 , 12),
                                          tcn1('Filter ${fActiveTickets.toString()}  ', Colors.blueAccent , 12)
                                        ],
                                      )
                                  ...
                                  child: Row(
                                    children: [
                                      ...
                                      Column(
                                        crossAxisAlignment: CrossAxisAlignment.start,
                                        children: [
                                          tc(holdTickets.toString(), Colors.orange , 25),
                                          tcn1('Hold  ', color3 , 12),
                                          tcn1('Filter ${fHoldTickets.toString()}  ', Colors.blueAccent , 12)
                                        ],
                                      )
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          tcn1('Filter ${fClosedTicket.toString()}  ', Colors.blueAccent , 12)
                                        ],
                                      )
                                    ...
                                    children: [
                                      ...
                                      Column(
                                        ...
                                        children: [
                                          ...
                                          tcn1('Filter ${fOverdueTicket.toString()}  ', Colors.blueAccent , 12)
                                        ],
                                      )
                                  ...
                                  Row(
                                    children: [
                                      ...
                                      Bounce(
                                        onPressed: (){
                                            if(mounted){
                                              var filDate =  setDate(2, DateTime.now());
                                              setState(() {
                                      ...
                                      Bounce(
                                        ...
                                        child: Container(
                                          padding: const EdgeInsets.symmetric(horizontal: 20,vertical: 4),
                                          decoration: boxOutlineCustom1(Colors.white, 30, Colors.black, 0.5),
                                          child: Row(
                                            mainAxisAlignment: MainAxisAlignment.center,
                                            children: [
                                              const Icon(Icons.clear_all_outlined, color: Colors.black,size: 12,),
                                              gapWC(5),
                ...
                Container(
                  ...
                  child: Column(
                    children: [
                      ...
                      gapHC(10),
                      notificationList.where((e) => e["READ_YN"] != "Y").isNotEmpty?
                      badges.Badge(
                        position: badges.BadgePosition.topEnd(end: -3,top: -9),
                        badgeColor: Colors.redAccent,
                        padding: const EdgeInsets.all(6),
                        badgeContent: tcn1(((notificationList.where((e) => e["READ_YN"] != "Y")).length).toString(), Colors.white, 12),
                        child: Bounce(
                          duration: const Duration(milliseconds: 110),
                          onPressed: (){
                            if(mounted){
                          ...
                          children: [
                            ...
                            Bounce(
                              ...
                              child: Container(
                                ...
                                height: 70,
                                width: 70,
                                decoration: boxGradientDecorationBase(7, 100),
                                padding: const EdgeInsets.symmetric(horizontal: 10,vertical: 5),
                                child: tc(g.wstrUserName.toString().substring(0,2).toUpperCase(), Colors.white, 20),
                              ),
                            ),
                            gapHC(5),

                            tc(g.wstrUserName.toString().toUpperCase(), Colors.black, 14),
                            tcn(g.wstrUserCd.toString(), Colors.black.withOpacity(0.6), 10),
                            tcn(g.wstrUserDepartmentDescp.toString(),Colors.black,10),
                                        ...
                                        Row(
                                          children: [
                                            ...
                                            Container(
                                              ...
                                              child: tcn(((notificationList.where((e) => e["READ_YN"] != "Y")).length).toString(), Colors.white  , 8),
                                            ):gapHC(0)
                                          ],
                                        ),
  ...
  //======================================WIDGET
    ...
    List<Widget> wTaskList(){
      ...
      for(var e in lstrTaskList){
        ...
        var deadline  =  deadlineDate != ""? setDate(7, DateTime.parse(deadlineDate)):"";
            ...
            child: Container(
              ...
              child: Column(
                ...
                children: [
                  Row(
                    children: [
                      wRowDet(stcn("${srno.toString()} .  $docno", color3, 10),1),
                      wRowDet(Column(
                        crossAxisAlignment: CrossAxisAlignment.start,
                        children: [
                          status == "C" || status == "D"?
                          tcs(taskHead.toString().toUpperCase(), priority == "CRITICAL" && status == "P"?Colors.red: Colors.black, 10):
                          stc(taskHead.toString().toUpperCase(), priority == "CRITICAL" && status == "P"?Colors.red: Colors.black, 10),
                          lstrViewDocno == docno?
                      ...
                      wRowDet(stc(clientCompany + " | " +clientCompanyName, color3, 10),2),
                      ...
                      PopupMenuButton<Menu>(
                        ...
                        itemBuilder: (BuildContext context) => <PopupMenuEntry<Menu>>[
                          PopupMenuItem<Menu>(
                            ...
                            child: SearchPopup(
                              searchYn: "N",
                              lstrColumnList: const [{"COLUMN":"DESCP","CAPTION":"Status"}],
                        ...
                        child:  Container(
                          decoration: boxBaseDecoration(status == "P"? Colors.green:status == "C"? Colors.red:status =="D"? Colors.purple:status =="A"? color2:status =="H"? Colors.orange:color2, 30),
                          padding: const EdgeInsets.symmetric(horizontal: 10,vertical: 3),
                          child: stcn(status == "P"?"Open":status == "C"?"Closed":status =="D"?"Dropped":status =="A"?"Started":status =="H"?"Hold":"", Colors.white, 10),
                      ...
                      wRowDet(stcn(createUser.toString().toUpperCase(), color3, 10),1),
                  ...
                  //   ),
                  // ),
                  (taskStatus == "C" || taskStatus == "D") && lstrViewDocno == docno?
                  Container(
                  ...
                  Row(
                    ...
                    children: [
                      Container(
                        ...
                        decoration: boxOutlineCustom1(Colors.transparent, 5, Colors.black , 0.5),
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.start,
                          children: [
                            Row(
                              children: [
                                const Icon(Icons.album_rounded,color: Colors.green,size: 10,),
                                gapWC(10),
                                tc('Last Status', Colors.black, 10),
                              ],
                            ),
                            tcn(lastStatus.toString().toUpperCase(), color3, 10),
                            tcn('ACTIVE USER :  ${activeUser.toString().toUpperCase()}', color3, 10),
                          ],
                        ),
                      ),
                      Bounce(
                    ...
                    children: [
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Row(
                            children: [
                              lstrMenuHoverMode == "PROFILE" && status =="A" ?
                              PopupMenuButton<Menu>(
                                position: PopupMenuPosition.under,
                                tooltip: "",
                                onSelected: (Menu item) {
                                ...
                                itemBuilder: (BuildContext context) => <PopupMenuEntry<Menu>>[
                                  PopupMenuItem<Menu>(
                                    value: Menu.itemOne,
                                    padding: const EdgeInsets.symmetric(vertical: 0,horizontal: 0),
                                    child: wHoldPopup(docno,doctype),
                                  ),
                                ],
                                child:   wSettingsCard(Icons.pause),
                              ):gapWC(0),
                              gapWC(5),
                              Bounce(
                                  duration: const Duration(milliseconds: 110),
                              ...
                              PopupMenuButton<Menu>(
                                ...
                                itemBuilder: (BuildContext context) => <PopupMenuEntry<Menu>>[
                                  PopupMenuItem<Menu>(
                                    value: Menu.itemOne,
                                    padding: const EdgeInsets.symmetric(vertical: 0,horizontal: 0),
                                    child: wFinishPopup(docno,doctype),
                                  ),
                                ],
                                child:   wSettingsCard(Icons.task_alt_rounded),
                              )
                              :gapWC(0),
                              gapWC(5),
                              Bounce(
                              ...
                              Bounce(
                                  ...
                                  onPressed: (){
                                    if(mounted){
                                      setState(() {
                                        ...
                                        lstrTMainCompanyCode = mainClientId;
                                  ...
                                  child: wSettingsCard(Icons.add_task_outlined)),
                              gapWC(5),
                     ...
                     children: [
                       Expanded(child: Row(
                         children: [
                           ...
                           gapWC(5),
                           (column == "PRIORITY" && flPriorityList.isNotEmpty) ||(column == "ISSUE_TYPE" && flIssueTypeList.isNotEmpty) ||   (column == "DEPARTMENT" && flDepartment.isNotEmpty)||   (column == "DOCNO" && flDocno.isNotEmpty)
                               ||(column == "COMPANY_NAME" && flCompanyList.isNotEmpty)||(column == "MODULE" && flModuleList.isNotEmpty)||(column == "CREATE_USER" && flUserList.isNotEmpty) ||(column == "CREATE_DATE" && flCreateDate.isNotEmpty)
                               ?
                           Container(
                             padding: const EdgeInsets.symmetric(vertical: 1,horizontal: 5),
                             decoration: boxBaseDecoration(color2, 5),
                             child: tcn((column == "PRIORITY"?flPriorityList.length:column == "ISSUE_TYPE"?flIssueTypeList.length:column == "COMPANY_NAME"?flCompanyList.length:column == "CREATE_USER"?flUserList.length:column == "MODULE"?flModuleList.length:column == "DEPARTMENT"?flDepartment.length:'1').toString(), Colors.white, 10),
                           ):
                           gapWC(0),
                         ],
                       ),),
          ...
          child: Column(
            children: [
              GestureDetector(
                  ...
                  child: tcn(flCreateDate.isEmpty?"Choose Date":flCreateDate, bgColorDark, 12)
              ),
              gapHC(20),
              GestureDetector(
                onTap: (){
          ...
          Bounce(
            ...
            child: Container(
              ...
              child: Row(
                mainAxisAlignment: MainAxisAlignment.center,
                children: [
                  const Icon(Icons.task_alt,color: Colors.white,size: 12,),
                  gapWC(5),
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            gapWC(5),
                            tc1(flAssignUserFrom.length.toString(), Colors.black, 12),
                          ],
                        ),
                        GestureDetector(
                          onTap: (){
                      ...
                      children: [
                        Row(
                          children: [
                            ...
                            gapWC(5),
                            tc1(flAssignUserTo.length.toString(), Colors.black, 12),
                          ],
                        ),
                        GestureDetector(
                            onTap: (){
    ...
    return  Container(
      ...
      child: Column(
        ...
        children: [
          Row(
            children: [
              const Icon(Icons.access_time_outlined,color: color2,size: 15,),
              gapWC(10),
        ...
        Bounce(
          ...
          child: Container(
            ...
            child: Row(
              children: [
                CircleAvatar(
                  backgroundColor:readYn == "Y"? Colors.redAccent :Colors.green,
                  radius: 13,
                  child: Icon(Icons.notifications_on_outlined,color: Colors.white, size: 13,),
                ),
                gapWC(5),
                Expanded(
                  child: Column(
  ...
  fnTaskCallBack(users,department,mode,note,deadLine,workMin){
    apiMoveTask(lstrAssignDocno, lstrAssignDoctype, users,department,mode,note,deadLine,workMin);
  }
  ...
  apiGetTask(mode){
    ...
    var client = [],task= [],issue= [],clientType= [],status= [],userList= [],priorityList= [],moduleList = [],assignFrom= [],assignTo = [],department = [];
    ...
    futureForm = apiCall.apiGetTask(flDocno.isEmpty?null:flDocno,flDocno.isEmpty?null:"TASK",from.isEmpty?null:from,to.isEmpty?null:to,g.wstrMainClientId,"",lstrTaskListPageNo,sortCol,sortDir,txtSearch.text,client,task,issue,clientType,status,userList,priorityList,flOverDueYn,moduleList,profileYn,assignFrom,assignTo,department);
  ...
  apiGetTaskExport(){
    ...
    futureForm = apiCall.apiGetTask(flDocno.isEmpty?null:flDocno,flDocno.isEmpty?null:"TASK",from.isEmpty?null:from,to.isEmpty?null:to,g.wstrMainClientId,"",-1,sortCol,sortDir,txtSearch.text,client,task,issue,clientType,status,userList,priorityList,flOverDueYn,moduleList,profileYn,assignFrom,assignTo,department);
  ...
  apiMoveTask(docno, doctype,users,department,mode,note,deadLine,workMin){
    var userList = [];
    if(mode == "U"){
      if(users.isNotEmpty){
        for(var e in  users){
    ...
    futureForm =  apiCall.apiMoveTask(docno, doctype, userList,department,note,deadLine,workMin);
  ...
  Future<void> setupMqttClient() async {
    ...
    mqttClientManager.subscribe("BEAMS_NOTY/${g.wstrUserCd.toString().toLowerCase()}");
  }
  ...
  fnSendMessage(){
    mqttClientManager.publishMessage("BEAMS_NOTY/${g.wstrUserCd.toString().toLowerCase()}", "Hello");
  }
  ...
  Future<void> fnExport(taskList) async{
    ...
    final excel.ExcelTable table1 = sheet.tableCollection.create('Table1',  sheet.getRangeByName('A$tableStart:L$srno'));
    ...
    if (kIsWeb) {
      ...
      Platform.isWindows ? '$path\\BeamsTMS$reportDate.xlsx' : '$path/BeamsTMS$reportDate.xlsx';
