...
class ApiCall  with BaseController{
  ...
  Future<dynamic> apiClientLogin(usercd,password) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/client_login',request).catchError((error){
  ...
  Future<dynamic> apiClientDirectLogin(key) async{
    ...
    dprint(key);
    var response = await ApiManager().postLink('api/application_login/?code='+key).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiUserLogin(user,password) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/user_login',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiGetCompanyModule() async{
    ...
    var response = await ApiManager().postLink('api/company_module').catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
 ...
 //============================================TASK
  ...
  Future<dynamic> apiGetTaskMasters() async{
    ...
    var response = await ApiManager().postLink('api/get_task_masters').catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiSaveTask(task,checklist,platform,mode,userList) async{
    ...
    dprint('api/savetask');
    dprint(request);
    var response = await ApiManager().post('api/savetask',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiGetTask(docno,doctype,from,to,mainClientId,clientYn,page,sortCol,sortDir,search,client,task,issue,clientType,status,userList,priorityList,overdueYn,moduleList,profileYN,assgnFrom,assgnTo,department) async{
    ...
    dprint('api/tasklist');
    dprint(request);
    var response = await ApiManager().post('api/tasklist',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiGetTaskDet(mainClientId,docno,doctype) async{
    ...
    dprint('api/viewtask');
    dprint(request);
    var response = await ApiManager().post('api/viewtask',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiDeleteTask(docno,doctype) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/deletetask',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiUpdateTask(docno,doctype,status,issue,priority) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/updatetask',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiAddTaskComment(docno,doctype,comment) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/addcomment',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
 ...
 //============================================TASK ACTIONS
  ...
  Future<dynamic> apiStartTask(docno,doctype) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/starttask',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiResumeTask(docno,doctype) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/resumetask',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiHoldTask(docno,doctype,note) async{
    ...
    dprint('api/holdtask');
    dprint(request);
    var response = await ApiManager().post('api/holdtask',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiMoveTask(docno,doctype,userList,department,tsfNote,asgnDeadline,workMin) async{
    ...
    dprint('api/movetask');
    dprint(request);
    var response = await ApiManager().post('api/movetask',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiFinishTask(docno,doctype,note) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/finishtask',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
...
//============================================ACTIVATION
  Future<dynamic> apiSaveMainCompany(companyId,companyName,mode) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/savemainclient',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiSaveProduct(id,name,note,mode) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/saveproduct',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiGetPendingActivation(search,type) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/activationlist',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiActivate(main,client,product) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/saveclientproduct',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiAllNotification(page) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/allnotification',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
  ...
  Future<dynamic> apiReadNotify(id) async{
    ...
    dprint(request);
    var response = await ApiManager().post('api/readnotify',request).catchError((error){
      if (error is BadRequestException) {
      } else {
        handleError(error);
      }
...
//============================================TASK REPORT
  ...
  Future<dynamic> apiTaskReport(column,startDate,endDate,keyVal) async{
